package hackathon.co.kr.neopen.sdk.broadcastreceiver;
...
import hackathon.co.kr.neopen.sdk.pen.MultiPenCtrl;
...
public class BTDuplicateRemoveBroadcasterReceiver extends BroadcastReceiver{
	 ...
	 */
	public static final String ACTION_BT_REQ_CONNECT = "hackathon.co.kr.neopen.sdk.connection.reqconnect";
	/**
	 ...
	 */
	public static final String ACTION_BT_RESPONSE_CONNECTED = "hackathon.co.kr.neopen.sdk.connection.connected";
